...
SETTINGS_SCHEMA: dict = {
    ...
    "appearance": {
        ...
        "backgroundBlur": {
            "default": False,
            "type": "boolean",
            "description": "Enable compositor background blur behind the launcher where supported",
        },
        "backgroundBlurPasses": {
            ...
            "max": 8,
            "step": 1,
            "description": "Niri blur pass count (higher = smoother blur, more GPU cost)",
        },
        "backgroundBlurOffset": {
            ...
            "max": 12,
            "step": 0.5,
            "description": "Niri blur offset multiplier (higher = stronger blur, may artifact if too high)",
        },
        "backgroundBlurSaturation": {
            "default": 1.5,
            "type": "slider",
            "min": 0,
            "max": 2,
            "step": 0.05,
            "description": "Niri background blur saturation (1=normal, 2=200%)",
        },
        "launcherXRatio": {
            "default": 0.5,
            "type": "slider",
